...
//            jsonObject.put("name", name);
     ...
     * @param point
     */
    public static void reviewCourse(Context context, MyBaseProgressCallbackImpl callback,String resourceId,String comment,String creationTime,String point) {
        JSONObject jsonObject = new JSONObject();
        try {
