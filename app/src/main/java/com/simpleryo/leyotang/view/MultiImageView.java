...
/**
 * @ClassNname：MultiImageView.java
 * @Describe 显示1~N张图片的View
 * @author huanglei
 * @time 2018/8/7 10:07
 */
...
public class MultiImageView extends LinearLayout {
	...
	private int pxImagePadding = DensityUtil.dip2px( 3);// 图片间的间距
	...
	private ImageView createImageView(int position, final boolean isMultiImage) {
		...
		if(isMultiImage){
            ...
            if(expectW == 0 || expectH == 0){
                ...
                imageView.setLayoutParams(new LayoutParams(449, 300));
            }
		}
