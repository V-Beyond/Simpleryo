...
/**
 * @ClassNname：AlignedTextUtils.java
 * @Describe 不同文字数目2端对齐工具类 (支持2-6个数字
 * @author huanglei
 * @time 2018/3/26 17:04
 */
public class AlignedTextUtils {
    ...
    public static SpannableString formatText(String str){
        ...
        {
            spannableString.setSpan(new RelativeSizeSpan((float)0.001), i, i + 1, Spanned.SPAN_INCLUSIVE_EXCLUSIVE);
